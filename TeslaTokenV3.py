...
if __name__ == "__main__":
    ...
    parser.add_argument("-u", "--email", type=str, required=True, help="Tesla account email")
    parser.add_argument("-p", "--password", type=str, required=True, help="Tesla account password")
    parser.add_argument("-f", "--file", type=str, required=False, default='token.txt', help="Filename to save tokens")
    parser.add_argument("-v", "--verbose", required=False, default=False, action="store_true", help="Be verbose")
    parser.add_argument("-d", "--device", choices=["1", "2"], required=False, default="1", help="2FA device to use")

    group = parser.add_mutually_exclusive_group(required=False)
    group.add_argument("-c", "--passcode", help="Passcode generated by your authenticator app")
    group.add_argument("-b", "--backup_passcode", help="Unused backup passcode")
